...
export default function DestinationPanel({ isOpen, onClose, lat, lng }: DestinationPanelProps) {
  ...
  return (
    <div className="fixed top-0 right-0 h-full w-96 bg-zinc-900 border-l border-zinc-700 shadow-2xl z-[100] overflow-y-auto">
      <div className="p-6">
        {/* Header */}
        ...
        {/* Placeholder content (we'll replace with real AI data next) */}
        <div className="space-y-8">
          ...
          <button 
            onClick={() => alert('🚀 Grok API call coming in the next step!')}
